...
#ifndef DCOMPDICTIONARY_HPP_
#define DCOMPDICTIONARY_HPP_
...
class DcompDictionary : public Dictionary {
private:
	csd::CSD *subjects;
	csd::CSD *predicates;
...
public:
	DcompDictionary();
	DcompDictionary(HDTSpecification &spec);
	~DcompDictionary();
...
#endif /* DcompDictionaryDictionary_HPP_ */
